                        ...
                        <d class="col-12">
                            <form action="" method="post">
                                <div class="p-2">
                                    ...
                                    <?php echo $form->input('last_name','w-100', 'text','last_name', $user->last_name, $user->last_name); ?>
                                </div>
                                <div class="p-2">
                                    <?php echo $form->label('first_name','Modifier le prénom'); ?>
                                    <?php echo $form->input('first_name','w-100', 'text','first_name', $user->first_name, $user->first_name); ?>
                                </div>
                                <div class="p-2">
                                    <?php echo $form->label('email','Modifier l\'email'); ?>
                                    <?php echo $form->input('email','w-100', 'text','email', $user->email, $user->email); ?>
                                </div>
                                <div class="p-2">
